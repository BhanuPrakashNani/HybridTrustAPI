# -*- coding: utf-8 -*-
"""Copy of [FYP]Core logic.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19rUSN-R7azur_j0iHjBCi4GShccTnlEJ
"""
...
np_user_feedback = user_feedback.values
columns = user_feedback.columns
for i in np_user_feedback:
  i[-1] = dp.parse(i[-1])
user_feedback = pd.DataFrame(np_user_feedback, columns = columns)
user_feedback
...
def getlist(input, topk, user_feedback):
  ...
  for k,v in similar_users(input, dummy, topk):
    csp_set.add((user_feedback.loc[k]['Cloud_Service_Name'],v, user_feedback.loc[k]['Timestamp']))
  return list(csp_set)
